    ...
    <div className="about container my-5">
      ...
      <div className="row bg-secondary p-5 rounded align-items-center mb-5">
        ...
        <div className="col-md-6">
          ...
          <p className="lead">
            ...
            superyachts as well as other types of specialty and commercial vessels. Our mission is to provide the best
            services to our clients, ensuring that their vessels are equipped with state-of-the-art technology and
      ...
      <div className="row bg-secondary p-4 rounded align-items-center mb-5">
        ...
        <div className="col-md-6">
          ...
          <p className="lead">
            With multiple locations across Germany, HMC ensures that we are always within reach to serve our clients.
          </p>
      ...
      <div className="why-choose-section p-5 pt-2 mt-5">
        <h2 className="text-center">Why Choose HMC?</h2>
        <p className="text-center">
          Owners want the same service, if not better, that they can access on demand, and a handful of specialist firms
          are doing their best to meet consumer-driven demand on board.
        </p>
