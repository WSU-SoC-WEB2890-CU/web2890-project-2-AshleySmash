    ...
    <div className="homepage">
      <div className="hero-section">
        <div className="overlay p-5 rounded text-center">
          ...
          <p className="tagline text-white-50 ">Integrating luxury with advanced technology.</p>
        ...
        <div className="row">
          <div className="col-md-4 mb-4">
            <div className="service-card bg-secondary rounded p-4 text-light">
              ...
              <p className="text-white-50">Custom design solutions for luxury vessels.</p>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="service-card bg-secondary rounded p-4 text-light">
              ...
              <p className="text-white-50">Expert installation and ongoing support.</p>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="service-card bg-secondary rounded p-4 text-light">
              ...
              <p className="text-white-50">Comprehensive security systems for safety.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="image-section container mx-auto mb-4">
        ...
        <a href="/commercial-vessels" className="image-card m-4">
          <img src={commercialVesselImage} alt="Commercial Vessel" className="rounded" />
          <div className="overlay rounded">
      ...
      <div className="cta-section bg-secondary text-center py-5 mb-5">
        ...
        <a href="/contact" className=" mt-3 btn btn-highlight btn-lg text-decoration-none fs-4 px-5 py-4">
          Get Started
        </a>
      </div>
    </div>
